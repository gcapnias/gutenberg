...
-   Excerpt field: render nothing for an empty excerpt. The `Add an excerpt` placeholder is now shown by the DataForm `panel` layout through its `empty` option. ([#82423](https://github.com/WordPress/gutenberg/pull/82423))
